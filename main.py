...
empty_values_request = {
    "function": "create",
    "object_type": "artist",
    "identifier": "1234345256345634",
    "attributes": {
        "user_id": "1234345256345634",
        "artist_name": "Jammin' Julius",
        "email": "julius@julius.com",
        "genres": "Reggae, Jamaican Dance Hall",
        "spotify_artist_id": "247563423fg3428762uhrg",
    },
}

success1, message1 = create_account(empty_values_request)
print(success1)
print(message1)
...
empty_values_request = {
    ...
    "attributes": {
        "user_id": "1234345256345635",
        "venue_name": "Julius' Juices",
        "email": "julius@juice.com",
...
success2, message2 = create_account(empty_values_request)
print(success2)
print(message2)
...
empty_values_request = {
    ...
    "identifier": "1234345256345636",
    "attributes": {
        "user_id": "1234345256345636",
        "first_name": "Julius",
        "last_name": "Caesar",
        "email": "justjthings@hotmail.com",
        "street_address": "Julius House, Julius Street",
        "city": "Juliopolis",
        "postcode": "AB1 CD2",
    },
...
success3, message3 = create_account(empty_values_request)
print(success3)
print(message3)
